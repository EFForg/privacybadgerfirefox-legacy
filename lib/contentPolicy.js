...
exports.ContentPolicy = Class({
  ...
  shouldLoad: function(contentType, contentLocation, requestOrigin, node, mimeTypeGuess, extra)
  {
    ...
    if (Policy.isHeuristicBlockedRequest(contentLocation, window)) {
      return Ci.nsIContentPolicy.REJECT_REQUEST;
    }
...
let Policy = exports.Policy =
{
   ...
   * @return {Boolean}
   */
  isHeuristicBlockedRequest: function(location, window)
  {
  ...
  shouldBlockRequest: function(location, window)
  {
    return (this.isUserRedRequest(location, window) ||
            this.isHeuristicBlockedRequest(location, window));
  }
};
