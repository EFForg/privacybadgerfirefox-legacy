...
let Policy = exports.Policy =
{
   ...
   * whether the URL is allowed by sample_whitelist.txt and/or userBlue.
   ...
   */
  isWhitelisted: function(location, parentUrl)
  {
    ...
    // Is the host in userBlue?
    if (location.hostname in storage.userBlue) {
      return "userBlue";
    }
