...
function init() {
  ...
  // recheck heuristic-blocked sites on startup and every 24 hours. Disabled
  // for alpha release because this needs to be implemented in a way that
...
function whitelistHostFromPrivacyPolicy(host) {
  ...
  // Unclobber the cookie *only* if it hasn't been clobbered by the user, since
