 ...
 */
let hasTracking = exports.hasTracking = function(channel, channelInfo, cookies) {
...
let blockOrigin = exports.blockOrigin = function(origin) {
  storage.blockedOrigins[origin] = true;
  // TODO: this is not enforced
};

let unblockOrigin = exports.unblockOrigin = function(origin) {
