...
const { Policy } = require("./pbContentPolicy");
...
let ignoreRequest = function(channel) {
  ...
  // Ignore anything that the user has explicitly added to userYellow/userBlue
  if ((channel.URI.hostname in storage.userYellow) ||
      (channel.URI.hostname in storage.userBlue)) {
    return true;
  }
