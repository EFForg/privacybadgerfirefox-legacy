...
let getChannelInfo = function(channel, win) {
  ...
  //TODO: is eTLD+1 the right thing to use for blocking? i.e., if we see
  //tracking cookies on tracking.ads.google.com, we count google.com.
...
let updateHeuristicsForChannel = function(channel, win) {
  ...
  if (win === null) {
    // Ignore requests not associated with a window
    return false;
  }
