 ...
 * @param {string} type either "response" or "request"
 * @param {nsIDOMWindow} win
 * @return {Boolean} whether the heuristics were updated
 */
let updateHeuristicsForChannel = function(channel, win, type) {
  ...
  if (type === "request") {
    ...
    emit(settingsMap, "update-settings", "cookieblock", win, channel.URI.host);
  }
