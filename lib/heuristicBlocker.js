 ...
 *
 * {
 *   origin: "",       // The origin (hostname) of this request
...
let updateHeuristicsForChannel = function(channel, win) {
  ...
  if (win === null) {
    // use referrer as parent origin
    channelInfo = {
      origin: channel.URI.host,
      parentOrigin: channel.referrer.host
    };
  } else {
    channelInfo = getChannelInfo(channel, win);
  }
