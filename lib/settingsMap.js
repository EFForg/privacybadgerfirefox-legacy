...
/* Ways for ApplicableList to get updated for a domwin:
...
function updateSettingsListener(msg, aWin, aOrigin) {
  ...
  console.log("settingsMap got update with: "+aOrigin);
...
function clearSettingsListener(aWin) {
  console.log("got window " + aWin);
  console.log("settingsMap got clear");
