...
/*
 * Enable Privacy Badger from the PB panel
 */
function enable() {
  prefsListener.init();
...
/*
 * Disable Privacy Badger from the PB panel
 */
function disable() {
...
function main(options) {
  ...
  enable();
  console.log("Started up", options.loadReason);
}
...
function heuristicEnable() {}
function heuristicDisable() {}
exports.main = main;
exports.onUnload = unload;
exports.enable = enable;
exports.disable = disable;
exports.heuristicEnable = heuristicEnable;
exports.heuristicDisable = heuristicDisable;
