...
//          deactivated_on_site: _("deactivated_on_site"),
//          activate_on_site: _("activate_on_site"),
//          click_badger_activate_on_site: _("click_badger_activate_on_site"),
//          status_none_detected: _("status_none_detected")
          status_none_detected: ("status_none_detected")
      },
      contentScriptWhen: "start"
});

//var popup = require(data.url("popup.js"));
//popup.port.on("getstring", function(id) {
//    popup.port.emit("gotstring", _(id));
//});
/**
