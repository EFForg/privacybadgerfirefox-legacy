...
exports.getSocialWidgetBlockList = function(tab) {
  ...
  socialWidgetList.forEach(function(socialWidget) {
    ...
    let aWin = tabUtils.getTabContentWindow(xulTab);
    let blockedData = pbUI.settingsMap.get(aWin);
...
exports.unblockSocialWidgetOnTab = function(tabId, socialWidgetUrls) {

}

function getXulTab(sdkTab) { 
